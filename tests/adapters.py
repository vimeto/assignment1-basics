...
from collections.abc import Iterable
from cs336_basics import tokenizer, fast_tokenizer
...
def run_linear(
    ...
    linear.load_state_dict({ "linear": weights })
...
def run_swiglu(
    ...
    swiglu.w1.linear.data = w1_weight
    swiglu.w2.linear.data = w2_weight
    swiglu.w3.linear.data = w3_weight
...
def run_multihead_self_attention(
    ...
    a.W_qkv.data = torch.cat([q_proj_weight, k_proj_weight, v_proj_weight], dim=0)
    # a.W_q.data = q_proj_weight
    # a.W_k.data = k_proj_weight
    # a.W_v.data = v_proj_weight
    a.W_o.data = o_proj_weight
...
def run_multihead_self_attention_with_rope(
    ...
    a = MultiHeadAttention(d_model, num_heads, None, rope)
    a.W_qkv.data = torch.cat([q_proj_weight, k_proj_weight, v_proj_weight], dim=0)
...
def run_transformer_lm(
    ...
    for l in range(num_layers):
        ...
        lm.layers[l].attn.W_qkv.data = w
        lm.layers[l].attn.W_o.data = weights[f"layers.{l}.attn.output_proj.weight"]
...
def run_rmsnorm(
    ...
    """
    from cs336_basics.modules.rms_norm import RMSNorm

    rms_norm = RMSNorm(d_model, eps)
    rms_norm.load_state_dict({ "gi": weights })
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.modules.swiglu import silu
...
def get_adamw_cls() -> Any:
    ...
    """
    from cs336_basics.modules.optimizers import AdamW
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.modules.optimizers import learning_rate_schedule
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.modules.checkpointing import save_checkpoint
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return fast_tokenizer.tokenizer(input_path, vocab_size, special_tokens)
